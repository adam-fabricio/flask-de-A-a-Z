...
Revision ID: ef23e211a975
Revises: 
Create Date: 2025-05-19 21:22:09.275648
...
def upgrade():
    ...
    sa.Column('date_updated', sa.DateTime(timezone=6), nullable=True),
    sa.Column('recovery_code', sa.String(length=128), nullable=True),
